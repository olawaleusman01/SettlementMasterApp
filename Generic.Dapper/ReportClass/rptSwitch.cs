    ...
    class rptSwitch
     {
        ...
        public static ExcelWorksheet generateReport(ExcelWorksheet ws, string img, string rName, string ID, string cardScheme, string reportType, string DOMINT, string reportClass, string sett, int startRow)
        {
            ...
            ws.Cells["A4"].Value = "SWITCH REPORT FOR " + CARDSCHEMDESC;
        ...
        public static string GenReport1(string reportFor, string ID, DateTime reportDate, string reportPATH, string SWITCHPath, string logopath, string reportFolder, string reportFolderType)
        {
            //FileInfo template = new FileInfo(reportPATH + @"\TEMPLATES\SWITCH Report Template.xlsx");
            string sett = reportDate.ToString("dd-MMM-yyyy");


            string reportname = reportFor + "_SWITCH.xlsx";


            string oSWITCHPath = System.IO.Path.Combine(SWITCHPath, "SWITCH");

            if (!Directory.Exists(oSWITCHPath))
            {
                System.IO.Directory.CreateDirectory(oSWITCHPath);
            }

            string oSWITCHPath2 = System.IO.Path.Combine(oSWITCHPath, reportFolder);

            if (!Directory.Exists(oSWITCHPath2))
            {
                System.IO.Directory.CreateDirectory(oSWITCHPath2);
            }
            string reportSWITCHPath = oSWITCHPath2 + "\\" + reportname;

            try
            {
                if (System.IO.File.Exists(reportSWITCHPath))
                {

                    System.IO.File.Delete(reportSWITCHPath);
            ...
            FileInfo newFile = new FileInfo(reportSWITCHPath);
            ...
            using (ExcelPackage package = new ExcelPackage(stream))
            {
                ...
                try
                {
                    ...
                    ws = generateReport(ws, logopath, reportFor, ID, "VISA", "SWTH_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws2 = generateReport(ws2, logopath, reportFor, ID, "VISA", "SWTH_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws3 = generateReport(ws3, logopath, reportFor, ID, "MAST", "SWTH_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4 = generateReport(ws4, logopath, reportFor, ID, "MAST", "SWTH_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4A = generateReport(ws4A, logopath, reportFor, ID, "VERV", "SWTH_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4B = generateReport(ws4B, logopath, reportFor, ID, "VERV", "SWTH_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws5 = generateReport(ws5, logopath, reportFor, ID, "PAYA", "SWTH_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws6 = generateReport(ws6, logopath, reportFor, ID, "PAYA", "SWTH_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws7 = generateReport(ws7, logopath, reportFor, ID, "CUPI", "SWTH_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws8 = generateReport(ws8, logopath, reportFor, ID, "CUPI", "SWTH_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws9 = generateReportSUMM(ws9, logopath, reportFor, ID, null, "SWTH_SUMM", reportFolderType, "P", sett, 8);

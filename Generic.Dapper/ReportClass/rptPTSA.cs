...
namespace UPPosMaster.Dapper.ReportClass
{
    class rptPTSA
    {
        ...
        public static ExcelWorksheet generateReport(ExcelWorksheet ws, string img, string rName, string ID, string cardScheme, string reportType, string DOMINT, string reportClass, string sett, int startRow)
        {
            ...
            ws.Cells["A4"].Value = "PTSA REPORT FOR " + CARDSCHEMDESC;
        ...
        public static string GenReport1(string reportFor, string ID, DateTime reportDate, string reportPATH, string PTSAPath, string logopath, string reportFolder, string reportFolderType)
        {
            //FileInfo template = new FileInfo(reportPATH + @"\TEMPLATES\PTSA Report Template.xlsx");
            string sett = reportDate.ToString("dd-MMM-yyyy");


            string reportname = reportFor + "_PTSA.xlsx";


            string oPTSAPath = System.IO.Path.Combine(PTSAPath, "PTSA");

            if (!Directory.Exists(oPTSAPath))
            {
                System.IO.Directory.CreateDirectory(oPTSAPath);
            }

            string oPTSAPath2 = System.IO.Path.Combine(oPTSAPath, reportFolder);

            if (!Directory.Exists(oPTSAPath2))
            {
                System.IO.Directory.CreateDirectory(oPTSAPath2);
            }
            string reportPTSAPath = oPTSAPath2 + "\\" + reportname;

            try
            {
                if (System.IO.File.Exists(reportPTSAPath))
                {

                    System.IO.File.Delete(reportPTSAPath);
            ...
            FileInfo newFile = new FileInfo(reportPTSAPath);
            ...
            using (ExcelPackage package = new ExcelPackage(stream))
            {
                ...
                try
                {
                    ...
                    ws = generateReport(ws, logopath, reportFor, ID, "VISA", "PTSA_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws2 = generateReport(ws2, logopath, reportFor, ID, "VISA", "PTSA_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws3 = generateReport(ws3, logopath, reportFor, ID, "MAST", "PTSA_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4 = generateReport(ws4, logopath, reportFor, ID, "MAST", "PTSA_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4A = generateReport(ws4A, logopath, reportFor, ID, "VERV", "PTSA_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4B = generateReport(ws4B, logopath, reportFor, ID, "VERV", "PTSA_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws5 = generateReport(ws5, logopath, reportFor, ID, "PAYA", "PTSA_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws6 = generateReport(ws6, logopath, reportFor, ID, "PAYA", "PTSA_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws7 = generateReport(ws7, logopath, reportFor, ID, "CUPI", "PTSA_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws8 = generateReport(ws8, logopath, reportFor, ID, "CUPI", "PTSA_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws9 = generateReportSUMM(ws9, logopath, reportFor, ID, null, "PTSA_SUMM", reportFolderType, "P", sett, 8);

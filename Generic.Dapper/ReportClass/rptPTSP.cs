...
namespace UPPosMaster.Dapper.ReportClass
{
    class rptPTSP
    {
        ...
        public static ExcelWorksheet generateReportSUMM(ExcelWorksheet ws, string img, string rName, string ID, string cardScheme, string reportType, string DOMINT, string reportClass, string sett, int startRow)
        {
            ...
            ws.Cells["A4"].Value = "SUMMARY REPORT " ;
            ws.Cells["A4"].Style.Font.Size = 14;
            ws.Cells["A4"].Style.Font.Bold = true;
            ws.Cells["A4:M4"].Merge = true;
            ws.Cells["A4:M4"].Style.HorizontalAlignment = ExcelHorizontalAlignment.CenterContinuous;
        ...
        public static string GenReport1(string reportFor, string ID, DateTime reportDate, string reportPATH, string PTSPPath, string logopath, string reportFolder, string reportFolderType)
        {
            //FileInfo template = new FileInfo(reportPATH + @"\TEMPLATES\PTSP Report Template.xlsx");
            string sett = reportDate.ToString("dd-MMM-yyyy");


            string reportname = reportFor + "_PTSP.xlsx";


            string oPTSPPath = System.IO.Path.Combine(PTSPPath, "PTSP");

            if (!Directory.Exists(oPTSPPath))
            {
                System.IO.Directory.CreateDirectory(oPTSPPath);
            }

            string oPTSPPath2 = System.IO.Path.Combine(oPTSPPath, reportFolder);

            if (!Directory.Exists(oPTSPPath2))
            {
                System.IO.Directory.CreateDirectory(oPTSPPath2);
            }
            string reportPTSPPath = oPTSPPath2 + "\\" + reportname;

            try
            {
                if (System.IO.File.Exists(reportPTSPPath))
                {

                    System.IO.File.Delete(reportPTSPPath);
            ...
            FileInfo newFile = new FileInfo(reportPTSPPath);
            ...
            using (ExcelPackage package = new ExcelPackage(stream))
            {
                ...
                try
                {
                    ...
                    ws = generateReport(ws, logopath, reportFor, ID, "VISA", "PTSP_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws2 = generateReport(ws2, logopath, reportFor, ID, "VISA", "PTSP_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws3 = generateReport(ws3, logopath, reportFor, ID, "MAST", "PTSP_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4 = generateReport(ws4, logopath, reportFor, ID, "MAST", "PTSP_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4A = generateReport(ws4A, logopath, reportFor, ID, "VERV", "PTSP_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws4B = generateReport(ws4B, logopath, reportFor, ID, "VERV", "PTSP_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws5 = generateReport(ws5, logopath, reportFor, ID, "PAYA", "PTSP_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws6 = generateReport(ws6, logopath, reportFor, ID, "PAYA", "PTSP_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws7 = generateReport(ws7, logopath, reportFor, ID, "CUPI", "PTSP_DR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws8 = generateReport(ws8, logopath, reportFor, ID, "CUPI", "PTSP_CR", reportFolderType, "P", sett, 8);
                ...
                try
                {
                    ...
                    ws9 = generateReportSUMM(ws9, logopath, reportFor, ID, null, "PTSP_SUMM", reportFolderType, "P", sett, 8);

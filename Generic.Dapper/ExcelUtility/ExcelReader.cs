//Shenwei Liu 4/11/2014: Class to import Excel data to generic list using Open XML SDK Lib
using System;
...
{ 
    ...
    public static IList<T> GetDataToList<T>(string filePath, Func<IList<string>, IList<string>, T> addRecord)
    {
    ...
    public static short? ToShortNullable(this string source)
    {
        short outNum;
        return short.TryParse(source, out outNum) ? outNum : (short?)null;
    }

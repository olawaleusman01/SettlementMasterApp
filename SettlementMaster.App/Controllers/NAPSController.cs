...
namespace SettlementMaster.App.Controllers
{
    public class NAPSController : Controller
    {
        ...
        public ActionResult GenerateNaps(DateTime SetDate, int Code, int navtype)
        {
            var html = "";
            var bid = "";
           // Session["navtype"] = navtype;
            try
            {
                Session["navtype"] = navtype;
                bid = SmartObj.GenRefNo();
                
                var rst = Naps.GenerateNaps(SetDate, Code, navtype, bid, "A", User.Identity.Name);
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public ActionResult Process(string[] selected,string ReqType,string ApproverId, string Navtype2)
        {
            try
            {

                Navtype2 = Session["navtype"].ToString();
        ...
        void BindCombo(short action,decimal? authId = null)
        {
            ...
            ////List<SelectListItem> Naptype = new List<SelectListItem>() {
            ////            new SelectListItem {
            ////                Text = "NAPS", Value = "1"
            ////            },
            ////            new SelectListItem {
        ...
        [HttpPost]
        // [ValidateAntiForgeryToken]
        public ActionResult Navtype(string Navtype2)
        {
            Session["navtype"] = null;
            Session["navtype"] = Navtype2;
            return null;
        }
    ...
    [HttpPost]
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public ActionResult ProcessUpld(string ApproverId, string Navtype2)
        {
            try
            {

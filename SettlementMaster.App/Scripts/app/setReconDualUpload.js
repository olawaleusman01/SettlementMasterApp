$(document).ready(function () {
    ...
    //alert(menuId);
    var url = BaseUrl() + 'SetReconDualUpload/';
    ...
    $(document).on('click', '#upload #btnUploada', function (e) {
        //alert('am clicked
        $("#tblUpld tbody").empty();
        e.preventDefault();
        loaderSpin2(true);
        if (window.FormData !== undefined) {
            ...
            $('#btnUploada').prop('disabled', true);
            $('#btnUploadb').removeAttr('disabled');
    ...
    $(document).on('click', '#upload #btnUploadb', function (e) {
        //alert('am clicked')
        //$("#tblUpld tbody").empty();
        e.preventDefault();
        loaderSpin2(true);

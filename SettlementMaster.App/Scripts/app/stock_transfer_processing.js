$(document).ready(function () {
    ...
    function BindGrid(location, category) {
        ...
        var $reqLogin = {
            url: url + 'SRProcessingList?id=', // + location + '&cat=' + category,
                                        ...
                                        '<ul class="nav nav-pills">' +
                                            '<li class="dropdown options">' +
                                                ...
                                                '<ul class="dropdown-menu" role="menu">' +
                                                    '<li><a href="' + url + "/SRProcessing/" + data[i].OrderNumber + '">View</a></li>' +
    ...
    $(document).on('click','a.editor_supply_partial', function (e) {
        e.preventDefault();
        alert('partial click');
        $('.notyModal').fadeOut();
    ...
    $('a.editor_supply_all').on('click', function (e) {
        e.preventDefault();

$(document).ready(function () {
    ...
    function BindGrid(location, category) {
        ...
        var $reqLogin = {
            url: url + 'POAuthList?id=', // + location + '&cat=' + category,
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            rw += '<tr>'
                                    ...
                                    + '<a href="' + BaseUrl() + "Purchase/POAuthDetail/" + data[i].OrderNumber + '" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> View</a>'

$(document).ready(function () {
    ...
    //alert(menuId);
    var url = BaseUrl() + 'PartyType/';
    var table2 = $('.datatable').DataTable({
        ajax: url + "PartyTypeList",
        columns: [
    ...
    function validateForm() {
        ...
        var validator = $("#formPType").validate({
            rules: {
                PARTYTYPE_CODE: "required",
                PARTYTYPE_DESC: "required",
    ...
    $("#PartyCodeReq").click(function () {
        var isChecked = $(this).is(":checked");

        $("#PARTYCODEREQUIRED").val(isChecked ? "Y" : "N");
    });
});
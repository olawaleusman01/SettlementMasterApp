$(document).ready(function () {
   ...
   // var url = BaseUrl() + '/ItemType/';
    ...
    var validator = $("#formUnit").validate({
        rules: {
       ...
       // alert( $('#ItbId').val());
        ...
        ajax.send($reqLogin).done(function (response) {
            ...
            if (response.RespCode === 0) {
                ...
                $('#UnitDescription').val(response.model.UnitDescription);
                $('#UnitShortCode').val(response.model.UnitShortCode);
